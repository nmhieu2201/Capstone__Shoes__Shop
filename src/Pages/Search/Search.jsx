...
import { getProductApiAction, searchProductApi } from '../../redux/productReducer/productReducer'
  ...
  const renderProductList = () => {
    ...
    if (sortProduct === undefined) {
      return searchProduct.map((prod, index) => {
        return <div className="col-sm-6 col-md-5 col-lg-4 col-xl-3 " key={index}>
          <div className="card">
      ...
      return sortProduct.map((prod, index) => {
        return <div className="col-sm-6 col-md-5 col-lg-4 col-xl-3" key={index}>
          <div className="card">
            ...
            <div className="card-footer">
              <NavLink style={{textDecoration: 'none'}} to={`/detail/${prod.id}`} className='buy'>Buy now</NavLink>
              <NavLink style={{textDecoration: 'none'}} className='price'>{prod.price}$</NavLink>
            </div>
          </div>
        </div>
      })
